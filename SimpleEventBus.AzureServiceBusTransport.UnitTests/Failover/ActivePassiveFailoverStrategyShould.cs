...
{
    [TestClass]
    public class ActivePassiveFailoverStrategyShould
    {
        ...
        ActivePassiveFailoverStrategy strategy;

        [TestInitialize]
        public void Setup()
        {
            strategy = new ActivePassiveFailoverStrategy(
                new[]
                {
        ...
        [TestMethod]
        public async Task SendToFirstClientOnly()
        {
